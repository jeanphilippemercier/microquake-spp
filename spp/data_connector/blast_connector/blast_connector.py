...
class blast_connector(object):
    ...
    def append_unmatched_appriximate(self):
        ...
        try:
            ...
            * FROM Matched_Blasts
            ...
            df_pitram = blast_connector().connect_pitram()
    ...
    def merge_on_chainage_exact(self):
        ...
        df_pitram = blast_connector().append_unmatched_appriximate()
        df = blast_connector().connect_cavecad()
        for i in range(0, len(df)):
            for l in range(0, len(df_pitram)):
                if (df_pitram['Location_modified'][l] == df['Location_modified'][i]) \
    ...
    def merge_on_matched_date_approximate(self):
        ...
        data["Min_Error"] = []
        index2 = []
        df_unmatched = blast_connector().merge_on_chainage_exact()[2]
        df_matched_accurate = blast_connector().merge_on_chainage_exact()[0]
        ...
        df_matched_approx_00 = df_matched_approx_00.loc[df_matched_approx_00.
                                                        ...
                                                        ['Min_Error'].idxmin()]
        df_pitram = blast_connector().append_unmatched_appriximate()
        index1 = blast_connector().merge_on_chainage_exact()[1]
    ...
    def merge_on_predictive_mode_approximate(self):
        ...
        df = blast_connector().connect_cavecad()
        df_unmatched = blast_connector().merge_on_matched_date_approximate()[2]
        for i in range(0, len(df)):
        ...
        for i in range(0, len(df_missed04)):
            for l in range(0, len(df_unmatched)):
                if (len(df_missed04[df_missed04.Index ==
                    ...
                    and ((df_missed04[df_missed04.Index == df_missed04["Index"][i]]
                         .reset_index()['ChainageTo'][0]) != (df_missed04[df_missed04.Index ==
                                                              df_missed04["Index"][i]].
                                                              reset_index()['ChainageTo'][1]))\
                   and (df_unmatched['MaxChainage'][l] >= 0):
                    function = func(df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToX'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToY'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToZ'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToX'][1],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToY'][1],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToZ'][1],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ChainageTo'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ChainageTo'][1],
                ...
                elif (len(df_missed04[df_missed04.Index == df_missed04["Index"][i]]) == 1)\
                    and (df_unmatched["Index"][l] == df_missed04["Index"][i]) and \
                    ...
                    function = func(df_missed04[df_missed04.Index ==
                                    ...
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ToZ'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['FromX'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['FromY'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['FromZ'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ChainageTo'][0],
                                    df_missed04[df_missed04.Index ==
                                                df_missed04["Index"][i]].reset_index()['ChainageFrom'][0],
                                    df_unmatched["MaxChainage"][l])
                    data['X'].append(function[0])
                    data['Y'].append(function[1])
                    data['Z'].append(function[2])
        ...
        df_matched_approx_01 = df_matched_approx_01.groupby("Index", sort=False, as_index=False).nth(0)

        df_pitram = blast_connector().connect_pitram()
        index1 = blast_connector().merge_on_chainage_exact()[1]
        index2 = blast_connector().merge_on_matched_date_approximate()[1]
    ...
    def merge_on_cavecad_processed_date_approximate(self):
        ...
        data["Min_Error"] = []
        index4 = []
        df_unmatched = blast_connector().merge_on_predictive_mode_approximate()[2]
        df = blast_connector().connect_cavecad()
        ...
        index1 = blast_connector().merge_on_chainage_exact()[1]
        index2 = blast_connector().merge_on_matched_date_approximate()[1]
        index3 = blast_connector().merge_on_predictive_mode_approximate()[1]
        ...
        df_matched_accurate = blast_connector().merge_on_chainage_exact()[0]
        df_matched_approx_00 = blast_connector().merge_on_matched_date_approximate()[0]
        df_matched_approx_01 = blast_connector().merge_on_predictive_mode_approximate()[0]
    ...
    def write_to_sql(self):
        ...
        engine = create_engine("sqlite:///" + self.input_dir, echo=False)
        conn = engine.connect()
        df_matched_all = blast_connector().merge_on_cavecad_processed_date_approximate()[1]
        df_unmatched = blast_connector().merge_on_cavecad_processed_date_approximate()[0]
        ...
        conn.close()
        engine.dispose()
        return print("Successfully updated SQLite database")

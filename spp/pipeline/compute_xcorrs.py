...
class Processor(ProcessingUnit):
    ...
    def initializer(self):
        ...
        hfname = os.path.join(os.environ['SPP_COMMON'], 'ot_cont', '10hr_sim.h5')
    ...
    def process(self, **kwargs):
        ...
        dc, ckeys_ix = xchange.xcorr_stack_slices(datgen, chans, cclen, sr_raw, sr, keeplag, whiten_freqs, onebit=onebit)

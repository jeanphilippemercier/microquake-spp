...
def test_measure_amplitudes():
    with open('./data/tests/test_measure_amplitudes_nlloc.xml', "rb") as event_file:
        catalog = read_events(event_file, format="QUAKEML")

    with open('./data/tests/test_measure_amplitudes_nlloc.mseed', "rb") as event_file:
